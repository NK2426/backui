...
export class DepartmentsService {
  ...
  DepartmentApiUrl: string = `${environment.FINANCE_BASE_URL}/departments`;
  ...
  delete(data: Department): Observable<Department> {
    return this.http.delete<Department>(this.DepartmentApiUrl + '/' + data.uuid);
  }

  getParams(): Observable<Department> {
    // console.log(this.http.get<Department>(this.DepartmentApiUrl + '/list', this.env.httpOptions));
    return this.http.get<Department>(this.DepartmentApiUrl + '/list', this.env.httpOptions);
  }
