...
export class CancelInvoicedetailsComponent {
  ...
  ngOnInit(): void {
    ...
    this.logistics = [{ id: '0', name: 'EcomExpress' }];
  }

  list(invoiceNumber: string) {
    this.invoiceService.getInvoiceById(invoiceNumber).subscribe({
