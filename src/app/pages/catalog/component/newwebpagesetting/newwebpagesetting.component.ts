...
@Component({
  selector: 'app-newwebpagesetting',
  templateUrl: './newwebpagesetting.component.html',
  styleUrls: ['./newwebpagesetting.component.scss'],
  standalone: true,
...
export class NewwebpagesettingComponent {
