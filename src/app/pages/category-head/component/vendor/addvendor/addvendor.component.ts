    ...
    this.formData = this.formBuilder.group(
      {
        ...
        zipcode: [this.data.zipcode, [Validators.required, Validators.pattern('[0-9]+'), Validators.maxLength(6), Validators.minLength(6)]],
        ...
        szipcode: [this.data.szipcode, [Validators.required, Validators.pattern('[0-9]+'), Validators.maxLength(6), Validators.minLength(6)]],
        ...
        next: (data) => {
          if (data) {
            ...
            this.formData.setValue({
              ...
              state_name: vendordetail?.state_name
