...
export class PaymentService {
    ...
    Payment_API_URL: string = `${environment.CATEGORY_HEAD_BASE_URL}paymentterms`;
    ...
    createPaymentTerm(data: Partial<PAYMENT.Payment>): Observable<PAYMENT.Payment> {
        return this.http.post<any>(this.Payment_API_URL, data, this.env.httpOptions).pipe(map(res=>res.data));
    }
    ...
    updatePaymentCycleOnEdit(paymentTermId: number, data: Partial<PAYMENT.Paymentcycle>): Observable<any> {
        return this.http.put<any>(this.Payment_API_URL + '/' + paymentTermId + '/paymentcycle-edit', data, this.env.httpOptions);
    }
